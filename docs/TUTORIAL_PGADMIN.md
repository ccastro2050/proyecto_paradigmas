...
> Dato importante: la BD del contenedor publica el puerto **15436** en su PC
...
| Port | `15436` | El puerto publicado (no el 5432 clásico, para no chocar con un PostgreSQL local) |
...
Abra en el navegador: **http://localhost:8006/api/producto/PR001**
...
- pgAdmin se conecta al puerto **15436** (el publicado por el compose). Si no
