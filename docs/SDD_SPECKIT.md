...
`main.py` ni en `requirements.txt`, y no cambia en nada cómo corre la API.
Es
...
| 4 | MEDIA | `3_plan` §2 ↔ `8_tasks` | El plan lista `servicios/abstracciones/i_servicio_producto.py` y ninguna tarea lo crea |
...
Convergencia — v1
    ...
    Criterio 6  FALLA no existe pruebas/prueba_capas.py

Se agregan a 8_tasks.md:
    ## Convergencia
    - [ ] T15 Mover la validación de tipo a la petición (int?) -> 422
    - [ ] T16 Crear pruebas/prueba_capas.py con el repositorio FALSO
...
- **La versión en curso:** [spec_kit/versiones/v1_producto_postgres/](spec_kit/versiones/v1_producto_postgres/2_spec.md)
...
7. En este repositorio: la [constitución](spec_kit/1_constitution.md), el
   ...
   [spec kit de la v1](spec_kit/versiones/v1_producto_postgres/2_spec.md).
