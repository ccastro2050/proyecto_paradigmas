...
```
# API corriendo LOCAL (venv + uvicorn), la BD publica el puerto 15436 al host:
postgresql+asyncpg://paradigmas:paradigmas123@localhost:15436/bdfacturas_postgres_local
