...
> el puerto 8006 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                STATUS                    PORTS
> proyecto_paradigmas-api-facturas-1   Up 2 hours                0.0.0.0:8006->8006/tcp
> proyecto_paradigmas-postgres-1       Up 2 hours (healthy)      0.0.0.0:15436->5432/tcp
> ```
>
...
| Qué | Dónde |
|---|---|
| **API Facturas — Swagger** (probar los endpoints) | http://localhost:8006/docs |
| Diagnóstico | http://localhost:8006/ |
| PostgreSQL (para DBeaver/pgAdmin, opcional) | `localhost:15436` · `paradigmas`/`paradigmas123` |
...
│
├── api_facturas/                # LA API DE LA v1 — FastAPI (puerto 8006)
